                            ...
                            <div class="sm:pb-6 sm:pt-0 px-4 bg-white">
                                ...
                                >
                                    ...
                                    <div class="pr-6 pb-4 sm:w-1/2 w-full">
                                        <InputLabel
                                            for="internShip"
                                            value="Stage * (Une fois enregistré, il n'y a plus de modification)"
                                        />
                                        <Multiselect
                                            id="internShip"
                                            v-model="form.intern_ship_id"
                                            autocomplete="off"
                                            :searchable="true"
                                            :options="internShips"
                                            name="internShip"
                                            placeholder="Chercher un stage"
                                        >
                                            <template #noresults>
                                                <div
                                ...
                                >
                                    ...
                                    <div class="w-full flex flex-col">
                                        ...
                                        <InputError
                                            class="mt-2"
                                            :message="form.errors.responsibilities"
                                        />
                                    </div>
                                </div>
                            </div>
