    ...
    >
        ...
        >
            ...
            <form
                ...
                @submit.prevent="sendCandidacy"
            >
                <div class="pt-4 px-6 w-full">
                    <InputLabel class="mb-1" for="cv" value="Votre CV :" />
                    <FileManager
                        class="w-full"
...
export default {
    ...
    emits: ["updateSendCandidacyModal"],
    ...
    computed: {
        showSendCandidacyModal: {
            get() {
                return this.show;
            },

            set(newValue) {
                this.$emit("updateSendCandidacyModal", newValue);
            },
        },
        ...
        checkIfSubmitButtonShouldBeDisabled() {
            return (
                ...
                this.isEmptyString(this.offerId) ||
                this.isEmptyString(this.studentId)
            );
        },
    },
    ...
    methods: {
        closeSendCandidacyModal() {
            ...
            this.showSendCandidacyModal = false;
        ...
        sendCandidacy() {
            this.form.post(
                `/apply-to-offer/${this.studentId}/${this.offerId}`,
                {
                    preserveScroll: true,
                    preserveState: true,
                    onBefore: () => {
                    ...
                    onSuccess: () => {
                        return Promise.all([this.closeSendCandidacyModal()]);
                    },
                },
            );
        },
